...
export class ReflectionEngine {
    candidates(experience) {
        const facts = [
            ...experience.decisions.map((content) => ({ kind: "decision", title: "经过验证的会话决策", content, prefix: "决策" })),
            ...experience.failures.map((content) => ({ kind: "constraint", title: "可复用的问题与限制", content, prefix: "问题" })),
        ];
